...
- **Diablo-style loot & gear** — monsters drop equipment under **glowing rarity-colored light beams** across **six slots** (weapon, helm, armor, boots, trinket, **charm**) in four rarities (Common → **Magic** → **Rare** → **Epic**) with rolled affixes (+ATK, +DEF, +Max HP, +speed%, +XP%, +coins%). The **Character screen** shows a paperdoll of your hero actually *wearing* the gear — rarity-colored helm band, armor sheen, glowing weapon, and an orbiting charm wisp — plus equip/unequip/salvage management. Gear is permanent — it survives death.
...
- **Dungeons: caves & sewers** — four **cave mouths** dot the wilderness and a **sewer grate** sits by each town. Enter one and you descend into a **generated rooms-and-corridors dungeon** (fresh layout every visit): pitch dark except your lantern light, glowing crystal veins, rich **ore nodes**, dense monsters at the dungeon's level, and — in the deepest room — a **golden treasure chest guarded by a boss**, spilling Rare+ gear and coins when opened. Sewers add glowing waste channels and mossy brickwork; deep-wilderness caves run far harder than town sewers. Take the glowing stairs out — or fall and wake at the campfire without your carried loot.
...
- **Pure real-time combat** — no turn-based interruptions: monsters that reach you bite for contact damage and shove you back, Hades-style. Kite, dash, cleave, or blink — every fight happens live on the map.
