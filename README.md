...
- **Animated brawler hero** — a proper little humanoid that **walks with swinging arms and legs**, faces the way you move, and idles with a breathing bob — Brawl Stars-style. Its gear matches your class (wizard hat + wand / hood + bow / helmet + sword) and the weapon glows in your lead's element. Critters are drawn as expressive cartoon brawlers too (big glossy eyes, eyebrows, cel-shaded bodies, type crests).
...
- **Gather & craft & build** — **chop trees** for wood (Age-of-Empires style) and collect **🪵 wood, 🪨 stone, 🌿 fiber** from logs, rocks, and shrubs, then open **🔨 Craft & Build** in the ☰ menu. Building stays active so you can lay down a whole row of walls in a row. Craft items (Orbs, Potions, Rations, Super Orbs) or place **buildables** — a **Campfire** or **Torch** (light), a **Wall** (blocks enemies), or your own **Hut** (a rest/heal/save point). Building enters a placement mode with a ghost preview (tap to place, ☰ to cancel).
- **Crafting level** — every craft earns crafting XP; leveling up unlocks better recipes (the Hut needs Craft Lv.2, Super Orbs Lv.3).
